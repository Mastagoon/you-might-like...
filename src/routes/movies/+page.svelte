<div class="mx-auto">
	<h1 class="text-3xl text-white font-bold">List 3 - 5 of your favorite movies</h1>
		<form class="flex flex-col gap-5 items-center my-2 text-white">
			<input type="text" class="bg-transparent border py-2 rounded-sm px-2 outline-blue" placeholder="Movie Name">
			<input type="text" class="bg-transparent border py-2 rounded-sm px-2 outline-blue" placeholder="Movie Name">
			<input type="text" class="bg-transparent border py-2 rounded-sm px-2 outline-blue" placeholder="Movie Name">
